...
columns1=['event_level_mean','event_stdv','model_mean','model_stdv','kmer_match','mean_diff']
#Feature importance
#columns1=['position']
...
#To check if a word found in word2vec words list
#words = list(model.wv)
#print(words)
#test='ATACG' in words
#print(",,,",test)
...
plt.xticks(fontsize=18, weight = 'bold') #To increase the font of the numbers on x axis and make it bold 
plt.yticks(fontsize=18, weight = 'bold') #To increase the font of the numbers on y axis and make it bold 
...
plt.savefig('loss_test_split_xgboost.png',dpi=300)
plt.close()
...
plt.tight_layout()
#plt.show()
plt.savefig('LC_test_split_xgboost.png',dpi=300)
plt.savefig('LC_test_split_xgboost.svg',dpi=300)
plt.close()
...
#plt.show() 
plt1.savefig('ROC_test_split_xgboost.png',dpi=300)
plt1.savefig('ROC_test_split_xgboost.svg',dpi=300)
plt1.close()
