...
df1 = pd.read_csv("coors_hek.txt",sep=' ',skiprows=(0),header=(0))
...
dataset.to_csv('Nm_benchmark_hek_sample.csv')          ##Pandas: write to csv File: https://realpython.com/pandas-read-write-files/
